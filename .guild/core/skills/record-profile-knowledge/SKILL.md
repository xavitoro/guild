...
*Canonical skill id: `record-profile-knowledge`*

Source of truth: [`SKILL.yaml`](SKILL.yaml) (schema `guild.skill-manifest/v1`).

## Goal

Append what a step verified to the owning profile's own knowledge ledger and hand the orchestrator a pointer to it rather than a copy.
