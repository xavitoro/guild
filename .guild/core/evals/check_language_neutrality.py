...
(.guild/core/agents/, .guild/core/skills/, .guild/core/workflows/,
.guild/core/templates/, .guild/core/spec/) — not .guild/core/adapters/
(which legitimately names Codex and Claude Code as the providers it
generates for) and not .guild/core/evals/ (whose tooling is necessarily
written in Python).
