...
`.guild/schemas/agent-manifest.schema.json`) and a human-readable
...
See `.guild/spec/GUILD_MASTER_SPEC.md` section 4 for the source definitions
and `.guild/templates/agent-manifest.template.yaml` for the manifest shape.
