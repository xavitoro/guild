...
9. **Explicit planning** — project state, dependencies and work items are visible in `.guild/planning/`.
...
```text
.guild/knowledge/project-memory.yaml
.guild/knowledge/PROJECT_MEMORY.md
.guild/knowledge/decisions/
.guild/knowledge/discoveries/
.guild/knowledge/patterns/
.guild/knowledge/archive/
```
...
.guild/planning/PROJECT_PLAN.md
.guild/planning/PROJECT_STATUS.md
.guild/planning/roadmap.yaml
.guild/planning/milestones/
.guild/planning/backlog/
.guild/planning/archive/
```
