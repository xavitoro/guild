...
(validates against `.guild/schemas/workflow.schema.json`, with each step validating
against `.guild/schemas/workflow-step.schema.json`) and a human-readable `workflow.md`
...
`.guild/spec/GUILD_MASTER_SPEC.md` section 9 for the source requirement.
