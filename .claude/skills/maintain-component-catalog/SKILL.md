---
name: maintain-component-catalog
description: Set up or update an isolated, browsable catalog of UI components so each can be developed, reviewed and visually verified independently of the full application.
---
