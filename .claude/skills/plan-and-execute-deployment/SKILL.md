---
name: plan-and-execute-deployment
description: Plan and, once approved, execute a deployment with a documented rollback path.
---

<!-- GENERATED FILE — DO NOT EDIT BY HAND.
     Source of truth: .guild/skills/plan-and-execute-deployment/SKILL.yaml (schema guild.skill-manifest/v1)
