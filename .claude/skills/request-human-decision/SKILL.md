...
description: Turn a decision no profile can make from the project itself into an answerable request, present it to the human, and record the answer — so nothing stays pending by default.
---
